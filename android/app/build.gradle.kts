...
android {
    ...
    buildTypes {
        release {
            ...
            // verifies against our published signed APK (TIC-101). findByName,
            // not getByName: fdroidserver deletes the signingConfigs block
            // before building, so this lookup must tolerate it being absent.
